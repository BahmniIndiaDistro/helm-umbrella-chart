...
exportWithMask "/$ENVIRONMENT/openmrs/DB_READ_ONLY_USERNAME" 'OPENMRS_READ_ONLY_DB_USERNAME'
exportWithMask "/$ENVIRONMENT/openmrs/DB_READ_ONLY_PASSWORD" 'OPENMRS_DB_READ_ONLY_PASSWORD'
...
exportWithMask "/$ENVIRONMENT/bahmni_mart/DB_READ_ONLY_USERNAME" 'MART_DB_READ_ONLY_USERNAME'
exportWithMask "/$ENVIRONMENT/bahmni_mart/DB_READ_ONLY_PASSWORD" 'MART_DB_READ_ONLY_PASSWORD'
